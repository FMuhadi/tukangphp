...
<head>
	<link rel="shortcut icon" href="absensi.ico?id=5569">
    ...
    <title>SI INSAN</title>

    <!-- Bootstrap Core CSS -->
    <link href="asset/js/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="asset/js/vendor/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="asset/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="asset/js/vendor/morrisjs/morris.css" rel="stylesheet">
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" ><img class="responsive-img" style="height: 35px;" src="asset/img/logo-v2.png"> </a>
            </div>
            <!-- /.navbar-header -->
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a onclick='reloadpage("userprofile.php");' ><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Table<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <?php
									$baseurl=base_url();
									foreach($listtables as $id => $name){
										echo "<li>";
										echo "<a onclick='reloadpage(\"".$name['Tables_in_siinsan']."\");'>".$name['Tables_in_siinsan']."</a>";
										echo "</li>";
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                        ...
                        <a onclick='reloadpage("cutidetail.php");'>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"></div>
                                    <div>Ontime 30 Hari Terakhir</div>
                                </div>
                            </div>
                        </div>
                        <a onclick='reloadpage("userprofile.php");'>
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
            ...
            <!-- /.row -->
            <div class="row">
                <iframe id='main_frame' width='100%' style='min-height:700px;min-width:1100px;border:0px;' src='//<?=base_url();?>'></iframe>
            </div>
            <!-- /.row -->
        </div>
        <!-- /#page-wrapper -->
	...
	<script>
		function reloadpage(link){
			$("#main_frame").attr("src","//<?=base_url();?>"+link);
		}
	</script>
	</body>
